...
figure,pcshow(cell2mat(data),'VerticalAxis', 'Y', 'VerticalAxisDir', 'Down');xlabel('x m');ylabel('y m');zlabel('z m');title('all');
for i = 1 : length(data)
    figure,pcshow(data{i},'VerticalAxis', 'Y', 'VerticalAxisDir', 'Down');xlabel('x m');ylabel('y m');zlabel('z m');title(num2str(i));
end
